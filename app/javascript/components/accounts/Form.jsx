...
class Form extends Component {
  ...
  render() {
  	const { disabled, account_number, routing_number, bank_name, bank_address, bank_location, validated, routingNumberError, accountNumberError } = this.state;
    return (
			<form>
			  ...
			  <div className="form-group row">
			    ...
			    <div className="col-sm-10">
			    	...
			    	required 
			    	/>
			    	<small id="routing-help" className={"small form-text mt-2 " + (routingNumberError ? 'text-danger' : 'text-muted')}>Must be a 9 digit number, e.g. 121143260.</small>
			    </div>
			  </div>				
			  <div className="form-group row">
